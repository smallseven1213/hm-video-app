...
class RecordPurchasePage extends StatefulWidget {
  const RecordPurchasePage({Key? key}) : super(key: key);

  @override
  _RecordPurchasePageState createState() => _RecordPurchasePageState();
}
...
class _RecordPurchasePageState extends State<RecordPurchasePage>
  ...
  void initState() {
    ...
    Get.find<PointProvider>().getManyBy().then((value) {
      setState(() {
        vods = value.vods;
          ...
          ? Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  InkWell(
                    onTap: () async {
                      for (int element in editingVods) {
                        // await Get.find<UserProvider>().deleteFavorite(element);
                      }
                      setState(() {});
                    },
                    child: Container(
