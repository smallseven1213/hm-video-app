...
class _CustomMaterialControlsState extends State<CustomMaterialControls>
  ...
  bool _forwardRewind = false;
  double _forwardOpacity = 0;
    ...
    return MouseRegion(
      ...
      child: GestureDetector(
        ...
        onDoubleTapDown: (detail) {
          ...
          setState(() {
            _forwardRewind = faster; // true: forward
            _forwardOpacity = .8;
          });
          Future.delayed(const Duration(milliseconds: 333)).then((value) {
            setState(() {
              _forwardOpacity = 0;
            });
          });
