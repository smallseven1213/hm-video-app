...
class CustomMaterialDesktopControls extends StatefulWidget {
  const CustomMaterialDesktopControls({
  ...
  State<StatefulWidget> createState() {
    return _CustomMaterialDesktopControlsState();
  }
}

class _CustomMaterialDesktopControlsState
    extends State<CustomMaterialDesktopControls>
  ...
  void _onExpandCollapse() {
    setState(() {
      ...
      widget.vodController.toggleFullscreen();
