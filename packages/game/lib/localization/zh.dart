const Map<String, String> zhTwStrings = {
  ...
  "funds_pin": "資金密碼",
  "tips": "溫馨提醒",
  "otp_verification_enter_code": "手機驗證 - 輸入驗證碼",
  "otp_verification_enter_phone_number": "手機驗證 - 輸入手機號碼",
  "otp_verification_prompt": "請輸入系統發送至+",
  "otp_verification_code_suffix": "的六位驗證碼",
  "otp_code": "驗證碼",
  "otp_unable_to_get_code": "無法取得驗證碼",
  "otp_code_resent": "驗證碼已重新發送",
  "otp_valid_duration": "有效時間",
  "otp_resend": "重寄",
  "plz_enter_phone_number": "請輸入手機號碼",
  "phone_number_format_error": "手機號碼格式錯誤",
  "otp_code_sent": "驗證碼已發送",
  "phone_binding_prompt": "綁定手機號後將會寄送驗證碼，請於五分鐘內進行驗證。",
  "phone_number": "手機號",
  "next": "下一步",
  "image_size_exceeds_limit": "圖片大小超過5MB",
  "image_size_exceeds_limit_prompt": "請重新選擇圖片，圖片大小不能超過5MB",
  "submission_success": "提交成功，請等待人員審核",
  "upload_img": "上傳圖片",
  "use_camera": "使用相機",
  "id_verification": "身分證驗證",
  "upload_front_id": "上傳身分證正面",
  "upload_back_id": "上傳身分證反面",
  "edit": "編輯",
  "file_size_limit": "檔案限制 5MB 以下、僅接受 jpg、jpeg 檔案格式",
  "submit": "提交",
  "binding_mobile": "綁定手機號",
  "bind_id_card": "綁定身分證",
  "complete_phone_verification_first": "請先完成手機號碼驗證",
  "complete_id_verification_first": "請先完成身分證驗證",
  "back": "返回",
