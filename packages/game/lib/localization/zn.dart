const Map<String, String> zhCnStrings = {
  ...
  "funds_pin": "资金密码",
  "tips": "温馨提醒",
  "otp_verification_enter_code": "手机验证 - 输入验证码",
  "otp_verification_enter_phone_number": "手机验证 - 输入手机号码",
  "otp_verification_prompt": "请输入系统发送至+",
  "otp_verification_code_suffix": "的六位验证码",
  "otp_code": "验证码",
  "otp_unable_to_get_code": "无法取得验证码",
  "otp_code_resent": "验证码已重新发送",
  "otp_valid_duration": "有效时间",
  "otp_resend": "重寄",
  "plz_enter_phone_number": "请输入手机号码",
  "phone_number_format_error": "手机号码格式错误",
  "otp_code_sent": "验证码已发送",
  "phone_binding_prompt": "绑定手机号后将会寄送验证码，请于五分钟内进行验证。",
  "phone_number": "手机号",
  "next": "下一步",
  "image_size_exceeds_limit": "图片大小超过5MB",
  "image_size_exceeds_limit_prompt": "请重新选择图片，图片大小不能超过5MB",
  "submission_success": "提交成功，请等待人员审核",
  "upload_img": "上传图片",
  "use_camera": "使用相机",
  "id_verification": "身分证验证",
  "upload_front_id": "上传身分证正面",
