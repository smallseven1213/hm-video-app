...
class UserCard extends SliverPersistentHeaderDelegate {
  final User info;
  ...
  double get maxExtent =>
      200; // You can adjust this value for the initial height of the UserCard
    ...
    return Container(
      ...
      child: Stack(
        children: [
          ...
          //   opacity: opacity,
          //   child: SidImage(
          //     key: ValueKey(user.coverVertical),
  ...
  @override
  bool shouldRebuild(covariant UserCard oldDelegate) {
    return oldDelegate.info != info || oldDelegate.context != context;
  }
}
