// create a Slider widget, return a empty container
...
class SupplierSlider extends StatelessWidget {
  const SupplierSlider({Key? key}) : super(key: key);
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      gradient: const LinearGradient(
                                        begin:
                                            Alignment.topLeft, // 这里可以根据需要进行调整
                                        end: Alignment
