...
class CoinOrderRecord extends StatefulWidget {
  const CoinOrderRecord({super.key});

  @override
  CoinOrderRecordState createState() => CoinOrderRecordState();
}

class CoinOrderRecordState extends State<CoinOrderRecord> {
